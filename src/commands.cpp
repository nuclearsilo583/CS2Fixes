...
WeaponMapEntry_t WeaponMap[] = {
	{{"bizon"},							"weapon_bizon",			"PP-Bizon",			4250, 26, GEAR_SLOT_RIFLE},
	{{"mac10", "mac"},					"weapon_mac10",			"MAC-10",			3750, 27, GEAR_SLOT_RIFLE},
	{{"mp5sd", "mp5"},					"weapon_mp5sd",			"MP5-SD",			3000, 23, GEAR_SLOT_RIFLE},
	{{"mp7"},							"weapon_mp7",			"MP7",				3250, 23, GEAR_SLOT_RIFLE},
	{{"mp9"},							"weapon_mp9",			"MP9",				4000, 34, GEAR_SLOT_RIFLE},
	{{"p90"},							"weapon_p90",			"P90",				3750, 19, GEAR_SLOT_RIFLE},
	{{"ump45", "ump"},					"weapon_ump45",			"UMP-45",			3000, 24, GEAR_SLOT_RIFLE},
	{{"ak47", "ak"},					"weapon_ak47",			"AK-47",			3700, 7, GEAR_SLOT_RIFLE},
	{{"aug"},							"weapon_aug",			"AUG",				4000, 8, GEAR_SLOT_RIFLE},
	{{"famas"},							"weapon_famas",			"FAMAS",			4000, 10, GEAR_SLOT_RIFLE},
	{{"galilar", "galil"},				"weapon_galilar",		"Galil AR",			4000, 13, GEAR_SLOT_RIFLE},
	{{"m4a4", "m4"},							"weapon_m4a1",			"M4A4",				4250, 16, GEAR_SLOT_RIFLE},
	{{"m4a1-s", "m4a1", "m4s"},				"weapon_m4a1_silencer",	"M4A1-S",			4250, 60, GEAR_SLOT_RIFLE},
	{{"sg553", "sg"},							"weapon_sg556",			"SG 553",			3750, 39, GEAR_SLOT_RIFLE},
	...
	{{"ssg08", "ssg"},					"weapon_ssg08",			"SSG 08",			3000, 40, GEAR_SLOT_RIFLE},
	{{"mag7", "mag"},					"weapon_mag7",			"MAG-7",			3600, 29, GEAR_SLOT_RIFLE},
	{{"nova"},							"weapon_nova",			"Nova",				3600, 35, GEAR_SLOT_RIFLE},
	{{"sawedoff", "saw"},						"weapon_sawedoff",		"Sawed-Off",		1600, 29, GEAR_SLOT_RIFLE},
	{{"xm1014", "xm"},					"weapon_xm1014",		"XM1014",			4250, 25, GEAR_SLOT_RIFLE},
	{{"m249"},							"weapon_m249",			"M249",				3800, 14, GEAR_SLOT_RIFLE},
	{{"negev"},							"weapon_negev",			"Negev",			4750, 28, GEAR_SLOT_RIFLE},
	...
	{{"fiveseven", "57"},						"weapon_fiveseven",		"Five-SeveN",		500, 3, GEAR_SLOT_PISTOL},
	{{"glock18", "glock"},				"weapon_glock",			"Glock-18",			200, 4, GEAR_SLOT_PISTOL},
	{{"p2000", "p2k"},							"weapon_hkp2000",		"P2000",			200, 32, GEAR_SLOT_PISTOL},
	...
	{{"hegrenade", "he"},				"weapon_hegrenade",		"HE Grenade",		5000, 44, GEAR_SLOT_GRENADES, 3},
	{{"molotov", "molo", "inc"},						"weapon_molotov",		"Molotov",			12000, 46, GEAR_SLOT_GRENADES, 1},
	{{"kevlar", "kev"},						"item_assaultsuit",			"Kevlar Vest",		1000, 51, GEAR_SLOT_UTILITY},
};
// clang-format on
...
CON_COMMAND_CHAT(stopmusic, "- print map music info")
{
	PrintInfoMapmusic(args, player);
}

CON_COMMAND_CHAT(music, "-print map music info")
{
	PrintInfoMapmusic(args, player);
}
...
void PrintInfoMapmusic(const CCommand &args, CCSPlayerController *player)
{
	...
	ClientPrint(player, HUD_PRINTTALK, CHAT_PREFIX "Type \x09snd_musicvolume <0.0-1.0> \x01 in console to adjust volume. Example: \x09snd_musicvolume 0.2");
}
