...
WeaponMapEntry_t WeaponMap[] = {
	{{"bizon"},							"weapon_bizon",			"PP-Bizon",			3750, 26, GEAR_SLOT_RIFLE},
	{{"mac10", "mac"},					"weapon_mac10",			"MAC-10",			3000, 27, GEAR_SLOT_RIFLE},
	{{"mp5sd", "mp5"},					"weapon_mp5sd",			"MP5-SD",			2250, 23, GEAR_SLOT_RIFLE},
	{{"mp7"},							"weapon_mp7",			"MP7",				2500, 23, GEAR_SLOT_RIFLE},
	{{"mp9"},							"weapon_mp9",			"MP9",				2500, 34, GEAR_SLOT_RIFLE},
	{{"p90"},							"weapon_p90",			"P90",				3500, 19, GEAR_SLOT_RIFLE},
	{{"ump45", "ump"},					"weapon_ump45",			"UMP-45",			2250, 24, GEAR_SLOT_RIFLE},
	{{"ak47", "ak"},					"weapon_ak47",			"AK-47",			3000, 7, GEAR_SLOT_RIFLE},
	{{"aug"},							"weapon_aug",			"AUG",				2700, 8, GEAR_SLOT_RIFLE},
	{{"famas"},							"weapon_famas",			"FAMAS",			2050, 10, GEAR_SLOT_RIFLE},
	{{"galilar", "galil"},				"weapon_galilar",		"Galil AR",			3100, 13, GEAR_SLOT_RIFLE},
	{{"m4a4", "m4"},							"weapon_m4a1",			"M4A4",				2800, 16, GEAR_SLOT_RIFLE},
	{{"m4a1-s", "m4a1", "m4s"},				"weapon_m4a1_silencer",	"M4A1-S",			2600, 60, GEAR_SLOT_RIFLE},
	{{"sg553", "sg"},							"weapon_sg556",			"SG 553",			2600, 39, GEAR_SLOT_RIFLE},
	...
	{{"mag7", "mag"},					"weapon_mag7",			"MAG-7",			1800, 29, GEAR_SLOT_RIFLE},
	{{"nova"},							"weapon_nova",			"Nova",				1350, 35, GEAR_SLOT_RIFLE},
	{{"sawedoff", "saw"},						"weapon_sawedoff",		"Sawed-Off",		1600, 29, GEAR_SLOT_RIFLE},
	{{"xm1014", "xm"},					"weapon_xm1014",		"XM1014",			3250, 25, GEAR_SLOT_RIFLE},
	{{"m249"},							"weapon_m249",			"M249",				3800, 14, GEAR_SLOT_RIFLE},
	{{"negev"},							"weapon_negev",			"Negev",			4500, 28, GEAR_SLOT_RIFLE},
